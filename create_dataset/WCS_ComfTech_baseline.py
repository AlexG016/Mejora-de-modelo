...
for sub in subjects[:12]:
    ...
    ecg = ph.nature2type(ph.from_pickle(f'{datadir}/{sub}/baseline/ecg_HB_b.pkl'))
    ibi = ph.nature2type(ph.from_pickle(f'{datadir}/{sub}/baseline/ibi_HB_b.pkl'))
